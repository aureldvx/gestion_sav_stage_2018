...
/**
 * MotifAnnulationReparation
 *
 * @ORM\Table(name="motif_annulation_reparation")
 * @ORM\Entity(repositoryClass="SAV\ProcessBundle\Repository\MotifAnnulationReparationRepository")
 */
class MotifAnnulationReparation
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="SAV\ProcessBundle\Entity\ParcoursProduit", mappedBy="motifAnnulationReparation")
     */
     ...
     *
     * @return MotifAnnulationReparation
     */
