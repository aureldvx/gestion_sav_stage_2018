 ...
 * @ORM\Entity(repositoryClass="SAV\ProcessBundle\Repository\StatutReparationRepository")
 */
class StatutReparation
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="SAV\ProcessBundle\Entity\ParcoursProduit", mappedBy="statutReparation")
     */
